...
addpath('Datasets\images\textfort'); %rajouter le chemin du dossier contenant les images
imagesnames = struct('name', {'21.png' , '22.png','23.png','24.png','25.png','26.png','27.png','28.png','29.png',...
    '30.png'});
save('imagesnames.mat');
addpath('Datasets\verite_terrain\textfort'); %rajouter le chemin du dossier contenant les vérités terrain
imagesv = struct('name', {'21v.png' , '22v.png','23v.png','24v.png','25v.png','26v.png','27v.jpg','28v.png','29v.png',...
    '30v.png'});
...
[seg1]=kmoyenne(image, 10);
[seg2]=otsu(image); 
 
 %%%%%%%calcul du taux d'exactitude%%%%%

 image2 = imread(imagesv(i).name); %lecture de la vérité terrain
